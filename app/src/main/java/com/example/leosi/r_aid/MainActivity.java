 ...
 public class MainActivity extends AppCompatActivity {
     ...
     final String PACKET3 = "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC";
     final String PACKET4 = "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD";
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         btn128 = (Button) findViewById(R.id.btn128);
         btn256 = (Button) findViewById(R.id.btn256);
         btnCriarLog = (Button) findViewById(R.id.btnCriarLog);
         ...
         btnCriarLog.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                    create_file();
             }
         ...
         btn256.setOnClickListener(new View.OnClickListener(){
             @Override
             public void onClick(View vk) {
                 if (conexao){
                     Locale local = new Locale("pt", "BR");
                     ...
                     final String dataHora = forma.format(calen.getTime());
                     id++;
                     connectedThread.write(id+"-"+dataHora+PACKET4+"#");
                 }else{
                     Toast.makeText(getApplicationContext(),"O bluetooth não está conectado!", Toast.LENGTH_LONG).show();
                 }
             }
     ...
     public void file_save(String loglog){
         String nomeArquivo = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/"+nomeDiretorio+"/"+"log.txt";
         try{
